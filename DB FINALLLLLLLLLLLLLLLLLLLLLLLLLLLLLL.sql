...
--
-- Host: localhost:3306
-- Waktu pembuatan: 14 Jan 2023 pada 17.28
-- Versi server: 5.7.33
-- Versi PHP: 8.1.3
...
(2, 'Dokter A', 'Laki-laki', 'Surabaya', '1962-10-29', 'Tenggilis X', 1, '2023-01-14 16:18:11', '2023-01-14 16:18:11', NULL),
(3, 'Dokter B', 'Perempuan', 'Makassar', '1987-12-29', 'Panakukkang', 1, '2023-01-14 16:18:55', '2023-01-14 16:18:55', NULL);
...
(1, 'Kategori A', '2023-01-14 16:11:21', '2023-01-14 16:11:21', NULL, 'Deskripsi kategori A'),
(2, 'Kategori B Edit', '2023-01-14 16:11:32', '2023-01-14 16:12:04', NULL, 'Deskripsi Kategori B Edit'),
(3, 'Kategori C', '2023-01-14 16:11:48', '2023-01-14 16:11:52', '2023-01-14 16:11:52', 'Deskripsi Kategori C');
...
(1, 'Selesai', '2023-01-14 16:20:50', '2023-01-14 16:22:26', 1, 2, 1, 'Keluhan pasien A', 'hsil diagnosa pasien A', '2023-01-15', '12:20:50', '12:22:26', 42000, 1, 'Cash', 25000),
(2, 'Selesai', '2023-01-14 16:21:02', '2023-01-14 16:23:48', 2, 3, 2, 'Keluhan Pasien B', 'hasil diagnosa pasien B', '2023-01-15', '12:21:02', '12:23:22', 25000, 1, 'Kredit', 10000);
...
(1, 'Obat A', 'Kategori A', 'Strip', '2023-01-14 16:12:24', '2023-01-14 16:12:24', NULL, 1000),
(2, 'Obat B', 'Kategori B Edit', 'Tablet', '2023-01-14 16:12:34', '2023-01-14 16:13:33', NULL, 2000),
(3, 'Obat C', 'Kategori A', 'Sirup', '2023-01-14 16:12:46', '2023-01-14 16:12:57', '2023-01-14 16:12:57', 3000);
...
(1, 1, 3, 2500, '2023-01-14 17:13:47'),
(1, 2, 15, 2000, '2023-01-14 17:14:07'),
(2, 1, 4, 3000, '2023-01-14 17:13:47'),
(2, 2, 5, 3000, '2023-01-14 17:14:07');
...
(1, '2023-01-15', '123455', '6544546', 'Pasien A', 'Ende', '1969-12-29', 0, 'Laki-laki', 'Aalmat pasien A', 'WIRASWASTA', 'ISLAM', '', '2023-01-14 16:19:24', '2023-01-14 16:19:24', NULL, 1),
(2, '2023-01-15', '031023', '394819', 'Pasien B', 'Ujung pndang', '1973-02-13', 0, 'Perempuan', 'Alamat pasienB', 'WIRASWASTA', 'ISLAM', '', '2023-01-14 16:19:54', '2023-01-14 16:19:54', NULL, 1),
(3, '2023-01-15', '11111', '2222', 'Pasien C UBAH', 'adas', '2023-01-16', 0, 'Laki-laki', 'asdasd', 'PNS', 'HINDU', '', '2023-01-14 16:20:19', '2023-01-14 16:20:38', '2023-01-14 16:20:38', 1);
...
(1, 'Poli A', '2023-01-14 16:14:21', '2023-01-14 16:14:21', NULL),
(2, 'Poli B', '2023-01-14 16:14:28', '2023-01-14 16:14:53', NULL),
(3, 'Poli C', '2023-01-14 16:14:35', '2023-01-14 16:14:39', '2023-01-14 16:14:39');
...
(1, '2023-01-15', '2023-01-14 16:13:47', '2023-01-14 16:13:47'),
(2, '2023-01-15', '2023-01-14 16:14:07', '2023-01-14 16:14:07');
...
(2, 'Dokter', 'Dokter A', 'doktera@doktera.com', NULL, '$2y$10$LabK/CKUUfdORxBHSve4luWJVe675FksvpJtB74anOxit5ePTtc1O', NULL, '2023-01-14 16:18:12', '2023-01-14 16:18:12'),
(3, 'Dokter', 'Dokter B', 'dokterb@dokterb.com', NULL, '$2y$10$T5oEX5NuT65CV1y/bdYR2Ow05/oVGm1r/MbwEmTa7zMyeG6f1Hj7i', NULL, '2023-01-14 16:18:56', '2023-01-14 16:18:56'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_pasien_harian`  AS SELECT `t`.`id` AS `tanggal`, (select count(`k`.`idkunjungan`) from `kunjungan` `k` where ((cast(`k`.`created_at` as date) = `t`.`id`) and (year(`k`.`created_at`) = 2023) and (`k`.`status_bayar` = 1))) AS `totalPasien` FROM `tanggal` AS `t``t`  ;
