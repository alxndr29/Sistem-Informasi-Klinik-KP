                            ...
                            <tbody>
                                ...
                                @for($i =0; $i <100;$i++)
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="badge badge-danger">{{rand(10,100)}}</span></td>
                                        <td class="text-center"><span class="badge badge-primary">{{rand(10,100)}}</span></td>
                                        <td class="text-center"><span class="badge badge-success">{{rand(50,100)}}</span></td>
