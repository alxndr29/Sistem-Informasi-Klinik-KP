...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Jan 2023 pada 06.26
-- Versi server: 5.7.33
-- Versi PHP: 8.1.11
...
(1, 'Menunggu Pembayaran', '2023-01-18 19:43:26', '2023-01-18 19:44:25', 1, 1, 1, 'ads', 'jnkadsa', '2023-01-19', '03:43:26', NULL, 55000, 0, 'Cash', 20000);
...
(1, 5, 10, 1000, '2023-01-19 06:25:13', 10),
...
--
ALTER TABLE `stok_in`
  MODIFY `idstok_in` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
